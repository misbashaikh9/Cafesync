...
const PromoSection = () => {
  ...
  const styles = {
    promo: {
      backgroundColor: 'linear-gradient(135deg, #faf8f3 0%, #f5f0e6 100%)',
      textAlign: 'center',
      padding: '100px 24px',
      position: 'relative',
      overflow: 'hidden',
          ...
          <div style={styles.countdownItems}>
            <div 
              ...
              onMouseEnter={(e) => {
                ...
                e.target.style.boxShadow = '0 15px 40px rgba(184, 134, 11, 0.3)';
                e.target.style.borderColor = '#b8860b';
              }}
              onMouseLeave={(e) => {
                e.target.style.transform = 'translateY(0) scale(1)';
                e.target.style.boxShadow = '0 8px 32px rgba(0, 0, 0, 0.1)';
                e.target.style.borderColor = 'rgba(184, 134, 11, 0.2)';
              }}
